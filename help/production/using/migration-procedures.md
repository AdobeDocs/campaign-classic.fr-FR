...
* Sous Windows, pour la mise à niveau du client et du serveur, désinstallez Adobe Campaign v6 avant d’installer la v7. N’oubliez pas de sauvegarder vos fichiers de configuration et de journal au préalable.
...
* [Réalisation d’une mise à niveau de build](https://helpx.adobe.com/fr/campaign/kb/acc-build-upgrade.html)
