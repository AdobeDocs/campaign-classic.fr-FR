...
>[!NOTE]
>
>Pour Microsoft SQL Server, vous pouvez utiliser le plan de maintenance décrit [sur cette page](http://ola.hallengren.com/sql-server-index-and-statistics-maintenance.html).
