...
1. Cliquez avec le bouton droit de la souris sur le dossier **[!UICONTROL Gestion > Plans de maintenance]** et sélectionnez ensuite **[!UICONTROL Assistant Plan de maintenance]** dans le menu contextuel.
