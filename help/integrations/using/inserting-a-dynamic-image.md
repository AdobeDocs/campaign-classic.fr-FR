...
Si vous utilisez les permissions d’Enterprise pour les paramètres d’Adobe Target, ajoutez la propriété correspondante dans ce champ. Pour en savoir plus sur les permissions de Target Enterprise, voir [cette page](https://marketing.adobe.com/resources/help/fr_FR/target/target/properties-overview.html).
...
1. Suivez la même procédure pour l’offre de redirection restante. Voir à ce propos [cette page](https://docs.adobe.com/help/fr-FR/target/using/experiences/offers/offer-redirect.html).
