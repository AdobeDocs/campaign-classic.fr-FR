...
# Créez une application Facebook{#creating-a-facebook-application}

![](../../assets/v7-only.svg)

Grâce aux applications web, le module Social Marketing de Campaign vous permet d&#39;afficher du contenu personnalisé dans vos applications Facebook, ce qui facilite l&#39;acquisition de prospects par le biais de ces médias sociaux. Pour plus d&#39;exemples d&#39;applications web de type Facebook, reportez-vous à la section [cette page](../../social/using/examples-of-facebook-apps.md).
...
1. Créez une ou plusieurs applications Facebook. [En savoir plus](../../social/using/publishing-on-facebook-walls.md#creating-a-facebook-application)
...
* Activé **Facebook**: sélectionnez l’application créée précédemment ( [https://developers.facebook.com/apps](https://developers.facebook.com/apps)), puis sélectionnez la variable **[!UICONTROL Paramètres]** > **[!UICONTROL De base]** .
...
* Activé **Adobe Campaign**: accédez à **[!UICONTROL Administration > Plateforme > Comptes externes]** et cliquez sur **[!UICONTROL Nouveau]**.

   ![](assets/social_webapp_fb_005.png)

1. Saisissez un libellé et un nom interne, puis sélectionnez la variable **[!UICONTROL Facebook Connect]** type.

   ![](assets/social_webapp_fb_006.png)

1. Sélectionnez le mode d&#39;hébergement de l&#39;application : **[!UICONTROL hébergé par un partenaire]** ou **[!UICONTROL hébergé sur cette instance]**.
...
## Renseignez les liens Conditions d&#39;utilisation et Politique de confidentialité {#entering-the-terms-of-service-and-privacy-policy-links}
...
1. Sélectionnez l&#39;onglet **[!UICONTROL Edition]**, puis modifiez l&#39;application web. [En savoir plus](../../social/using/examples-of-facebook-apps.md)
