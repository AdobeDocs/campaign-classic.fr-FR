...
1. Ouvrez la première activité, puis ajoutez la commande **instance.vars.isRunning = true** dans l’ **[!UICONTROL Advanced]** onglet. Ainsi, la variable d’instance est définie comme étant en cours d’exécution.
