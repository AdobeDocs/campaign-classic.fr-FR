...
Les boutons de la barre d&#39;outils sont présentés dans la section [section](../../campaign/using/marketing-campaign-deliveries.md#building-the-main-target-in-a-workflow). La variable **[!UICONTROL Actions]** donne accès à des options d&#39;exécution supplémentaires permettant d&#39;agir sur les workflows sélectionnés. Vous pouvez également utiliser le menu **[!UICONTROL Fichier > Actions]** ou cliquez avec le bouton droit de la souris sur un workflow et sélectionnez **[!UICONTROL Actions]**.
...
* **[!UICONTROL Redémarrer]**
  ...
  La variable **[!UICONTROL Démarrer / Mettre en pause / Arrêter / Redémarrer]** Les actions sont également disponibles à partir des icônes d&#39;exécution de la barre d&#39;outils. Pour plus d’informations à ce sujet, consultez cette [section](../../campaign/using/marketing-campaign-deliveries.md#creating-a-targeting-workflow).
...
* **[!UICONTROL Sauver comme modèle]**
  ...
  La variable **[!UICONTROL Mise à jour en masse des lignes sélectionnées]** et **[!UICONTROL Fusionner les lignes sélectionnées]** options sont des options de plateforme génériques disponibles dans toutes les **[!UICONTROL Actions]** menus. Pour plus d’informations à ce sujet, consultez cette [section](../../platform/using/updating-data.md).
