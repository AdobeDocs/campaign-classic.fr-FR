...
* **[!UICONTROL Sauver comme modèle]**
  ...
  Les options **[!UICONTROL Mettre à jour en masse les lignes sélectionnées]** et **[!UICONTROL Fusionner les lignes sélectionnées]** sont des options génériques de la plateforme disponibles dans tous les menus **[!UICONTROL Actions]**. Pour plus d’informations à ce sujet, consultez cette [section](../../platform/using/updating-data.md).
