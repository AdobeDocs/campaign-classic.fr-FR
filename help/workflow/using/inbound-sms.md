...
seo-title: Réception de SMS
description: Réception de SMS
...
1. **[!UICONTROL SMS routing]**: Sélectionnez le compte externe à utiliser pour la récupération SMS. Les comptes externes sont configurés via le **[!UICONTROL Administration > Platform > External accounts]** noeud de l’arborescence.
1. **[!UICONTROL Script]**
...
Les onglets **[!UICONTROL Script]**, **[!UICONTROL Schedule]** et **[!UICONTROL Expiry]** sont détaillés dans les Courriers électroniques [](../../workflow/using/inbound-emails.md)entrants.
