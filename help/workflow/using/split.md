...
1. L&#39;onglet **[!UICONTROL Général]** permet de renseigner le libellé ainsi que le contexte d&#39;exécution de la répartition (dimension de ciblage, champ de répartition).
   ...
   * **[!UICONTROL Type d’affectation]** : sélectionnez le type d’affectation de la répartition de données. Vous pouvez choisir entre une affectation par groupe ou opérateur ou opératrice, ou une affectation par entité locale. L&#39;affectation par entité locale est utilisée dans le cadre du **marketing distribué**. Pour plus d’informations, consultez cette [section](../../distributed/using/about-distributed-marketing.md).
