...
La tâche principale de ces activités consiste à attendre un événement. Il peut s’agir, par exemple, de la réception d’un fichier, d’un e-mail ou d’un signal envoyé par le programme.

* Collecteur de fichiers :  l’arrivée d’un ou plusieurs fichiers dans un répertoire et active sa transition pour chacun des fichiers reçus. Voir à ce sujet la section [Collecteur de fichiers](file-collector.md).
