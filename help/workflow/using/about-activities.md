...
Cette section décrit toutes les activités disponibles.En fonction du nœud ou du contexte dans lequel le workflow est créé/édité, les activités disponibles peuvent différer.Par exemple, les workflows créés dans une campagne comportent des activités de diffusion spécifiques à un canal.

Les activités de workflow sont regroupées par catégorie. Quatre onglets sont proposés simultanément.
