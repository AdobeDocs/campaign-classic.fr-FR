...
1. Vérifiez que le workflow de **[!UICONTROL Nettoyage de la base]** s’exécute et se termine correctement tous les jours. Pour plus d’informations, consultez [cette page](../../production/using/database-cleanup-workflow.md).
