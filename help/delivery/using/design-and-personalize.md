...
En savoir plus dans [cette section](../../delivery/using/sms-set-up.md#creating-an-smpp-external-account).
...
En savoir plus dans [cette section](../../delivery/using/sms-set-up.md#about-character-transliteration).
