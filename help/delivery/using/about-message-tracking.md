...
Grâce à ses fonctionnalités de tracking, Adobe Campaign permet de tracker les messages envoyés et de contrôler le comportement des destinataires : ouverture, clics sur des liens, désinscription, etc.
