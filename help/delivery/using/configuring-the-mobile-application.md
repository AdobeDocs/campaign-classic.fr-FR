...
* Créez un  de pour iOS et Android.
...
1. Dans le qui s’affiche, vérifiez le **[!UICONTROL des applications]** mobiles.
...
### Étape 2 : Configuration des  de iOS {#configuring-external-account-ios}
...
Votre connecteur iOS est maintenant configuré. Vous pouvez  créer votre service.
...
1. La fenêtre suivante s’affiche. Sélectionnez **[!UICONTROL Créer une application]** iOS et un  de en saisissant le **[!UICONTROL libellé]**.
...
1. L’onglet **[!UICONTROL paramètres]** vous permet de définir le mappage avec une extension de l’des applications **[!UICONTROL abonnées (nms:appsubscriptionRcp)]** .
...
1. Cliquez sur **[!UICONTROL Suivant]** pour  configuration de l’application de production et suivez les étapes décrites ci-dessus.
...
Vous devez maintenant créer un nouveau  de et le lier à l’application mobile que vous avez créée.
...
1. Sélectionnez **[!UICONTROL Livrer sur iOS (ios)]** dans la liste déroulante des **** . Ajouter une **[!UICONTROL étiquette]** à votre  de.

1. Cliquez sur **[!UICONTROL Pour]** définir la population à . Par défaut, le  de l’application **** abonné est appliqué. Cliquez sur **[!UICONTROL Ajouter]** pour sélectionner le service créé précédemment.

   ![](assets/nmac_ios_9.png)

1. Dans la fenêtre **[!UICONTROL Type]** de , sélectionnez **[!UICONTROL Abonnés d’une application mobile iOS (iPhone, iPad)]** et cliquez sur **[!UICONTROL Suivant]**.

1. Dans la liste déroulante **[!UICONTROL Service]** , sélectionnez votre service créé précédemment, puis l’application à , puis cliquez sur **[!UICONTROL Terminer]**.
...
### Étape 2 : Configuration des  de Android {#configuring-external-account-android}
...
1. Make sure the same **[!UICONTROL Integration key]** is defined in Adobe Campaign and in the application code via the SDK. Voir à ce sujet la section : [Intégrer le SDK Campaign dans l’application mobile](../../delivery/using/integrating-campaign-sdk-into-the-mobile-application.md).
...
1. Sélectionnez **[!UICONTROL Livrer sur Android (android)]** dans la liste déroulante des **[!UICONTROL de]** . Ajouter une **[!UICONTROL étiquette]** à votre  de.

1. Cliquez sur **[!UICONTROL Pour]** définir la population à . Par défaut, le  de l’application **** abonné est appliqué. Cliquez sur **[!UICONTROL Ajouter]** pour sélectionner le service créé précédemment.

   ![](assets/nmac_android_7.png)

1. Dans la fenêtre **[!UICONTROL Type]** de , sélectionnez Abonnés d&#39;une application mobile Android et cliquez sur **[!UICONTROL Suivant]**.
