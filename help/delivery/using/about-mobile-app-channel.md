---
product: campaign
title: 'Prise en main du canal des applications mobiles (documentation du produit) '
description: Prise en main de Mobile App Channel dans Adobe Campaign Classic
feature: Push
