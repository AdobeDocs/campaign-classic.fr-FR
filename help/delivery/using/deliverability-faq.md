...
Le message &quot;quotas atteints&quot; n&#39;indique donc pas seulement un problème de configuration, mais peut aussi être lié à la réputation. Il est important d&#39;analyser les messages d&#39;erreur dans le log SMTP.
...
* Mesures de publipostage ou de campagne : les taux de désabonnement/abus de plainte/rebond sont plus élevés que d&#39;habitude.
* activité d&#39;abonné : les ouvertures/clics/transactions sont inférieurs à la normale.
...
Les plaintes sont définies par les abonnés qui cliquent sur le bouton &quot;Ceci est du spam&quot;. Si votre problème de diffusion a été causé par des plaintes, vous devez essayer de déterminer pourquoi les destinataires se plaignent. Les clients ayant un taux de plaintes élevé peuvent également envisager de transférer leur lien de désabonnement au haut de leur courriel afin d’encourager les abonnés qui ont décidé d’appuyer sur le bouton spam à se désabonner au lieu de se plaindre.

Les expéditeurs peuvent recueillir une mine d&#39;informations à partir de leurs plaintes de boucle de rétroaction. Il est important de regrouper les données et de rechercher des schémas dans des éléments tels que la source d&#39;inclusion, la durée d&#39;abonnement de l&#39;adresse, ou même certaines données démographiques comportementales. Les plaintes peuvent souvent identifier une source ou un segment de données à risque dans le dossier. Le risque est défini comme le plus susceptible de se plaindre, ce qui peut nuire à la réputation, et en retour, les taux de boîte de réception.

Les plaintes proviennent également des abonnés qui ne veulent tout simplement plus recevoir de courrier électronique. Cela peut souvent être dû à des messages excessifs, à leur perception du message, au fait qu&#39;ils n&#39;attendaient pas le message, ou ne se souviennent pas avoir choisi. Il est également important d’exécuter une vérification pour s’assurer que tous les points de collecte sont clairs et qu’il n’y a pas de cases pré-cochées dans vos points d’acquisition. Vous devez également envoyer un courriel de bienvenue aux abonnés qui s&#39;abonnent pour donner le ton et expliquer à quelle fréquence ils peuvent s&#39;attendre à recevoir des courriels de votre part.

**Validité des données**

Les rebonds durs se produisent lorsque vous envoyez à une adresse non livrable à un fournisseur de services Internet. Une adresse peut être non livrable pour de nombreuses raisons, telles qu&#39;une adresse mal orthographiée, une mauvaise liste ou une source de données, ou l&#39;envoi par la poste à une adresse qui était active à un moment donné, mais qui a été fermée ou terminée après une période d&#39;inactivité. Si vous rencontrez un fort rebond, il est important de vérifier la liste. S’il provient d’une nouvelle source, vérifiez comment les adresses ont été collectées et assurez-vous qu’il y a eu autorisation. De mauvaises données peuvent également provenir d’adresses mal orthographiées. Il est possible de résoudre ce problème avec un service de validation des données en temps réel ou en exigeant une inclusion confirmée avant d’envoyer des courriers électroniques marketing à cette adresse.
...
Dans le cadre du maintien permanent de la réputation, il est important de comprendre comment les abonnés engagés se trouvent sur votre liste et d’établir une hiérarchie des risques de récence pour les abonnés de chaque dossier. La récence est définie comme la dernière date d&#39;ouverture/de clic/de transaction ou d&#39;inscription. Cette période peut différer selon la verticale. Déterminez les segments actifs (&quot;sûrs&quot;) pour chaque verticale. Il s’agit généralement des abonnés qui ont été actifs au cours des 3 à 6 derniers mois.

Réduisez la fréquence en inactifs. Créer une série de réengagements pour les actifs à risque modéré. Il s&#39;agit généralement de 6 à 9 mois sans engagement. Développer une campagne de reconfirmation pour les actifs à risque élevé. Il s’agit généralement d’abonnés qui n’ont pas utilisé de courriel depuis 9 à 12 mois. Enfin, vous devez définir une règle d’abandon et supprimer les abonnés qui n’ont pas ouvert depuis les mois x. Nous recommandons généralement plus de 12 mois, mais cela peut varier en fonction des ventes et du cycle d&#39;achat.
