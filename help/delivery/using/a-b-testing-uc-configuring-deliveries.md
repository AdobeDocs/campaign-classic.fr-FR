...
# Configuration des diffusions dans le processus {#step-4--configuring-the-deliveries-in-the-workflow}
...
Vous pouvez maintenant créer le script (voir [Étape 5 : Créez le script ](../../delivery/using/a-b-testing-uc-script.md)).
