...
Lorsque la diffusion fait partie d’une campagne, l’onglet **[!UICONTROL Avancé]** propose une option supplémentaire.celle-ci vous permet d’organiser l’ordre de traitement des diffusions d’une même campagne.
