---
product: campaign
title: S avec le MTA amélioré dans Adobe Campaign Classic
...
Pour en savoir plus sur les typologies, consultez [cette section](../../campaign-opt/using/about-campaign-typologies.md).
