...
* Pour un service de type E-mail, sélectionnez le **mode de diffusion**. Les modes possibles sont : **[!UICONTROL Newsletter]** ou **[!UICONTROL Viral]**.
...
Un service d’information peut avoir une durée limitée. Les destinataires seront automatiquement désabonnés à l&#39;expiration de la période de validité. Cette période est spécifiée dans l&#39;onglet **[!UICONTROL Edition]** des propriétés du service. Elle est exprimée en jours.
