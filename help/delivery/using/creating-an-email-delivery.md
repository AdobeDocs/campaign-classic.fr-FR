...
1. Sélectionner le modèle de diffusion **Diffusion Email (mail)** ou tout modèle de diffusion email que vous avez créé. Pour plus d&#39;informations sur les modèles de diffusion, reportez-vous à la section [cette section](about-templates.md).
