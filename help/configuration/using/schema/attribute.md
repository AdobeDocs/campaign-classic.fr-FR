...
* **length (string)** : nombremaximal de caractères autorisés pour une valeur du champ SQL de type « chaîne ».Si l’attribut « @length » n’est pas précisé, Adobe Campaign crée automatiquement un champ de 255 caractères.
