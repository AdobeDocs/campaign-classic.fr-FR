...
Pour en savoir plus sur la rétention des données, consultez les [Règles de confidentialité et de sécurité de Campaign](https://helpx.adobe.com/fr/campaign/kb/campaign-privacy-overview.html#consent).
