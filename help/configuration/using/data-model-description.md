...
Elle permet de gérer les abonnements des personnes destinataires à des services d’information.
...
Cet ensemble de tables, lié au module **Optimisation de campagne**, permet de contrôler, de filtrer et de surveiller l’envoi des diffusions. Consultez la [documentation de Campaign v8](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/campaign-typologies.html?lang=fr){target="_blank"}.
...
* **NmsOffer** : cette table correspond au schéma **nms:offer**. Elle contient la définition de chaque offre marketing.
...
* **NmsOfferView** : cette table correspond à **nms:offerView**. Elle contient les représentations des offres.
* **NmsOfferCategory** : cette table correspond à **nms:offerCategory**. Elle contient les catégories des offres.
* **NmsOfferEnv** : cette table correspond à **nms:offerEnv**. Elle contient les environnements des offres.
...
Cette table correspond au schéma **nms:rtEvent**. Elle contient une définition des événements en temps réel.
...
* **NmsAppSubscription** cette table correspond au schéma **nms:appSubscription**. Elle contient les informations relatives aux personnes abonnées concernant une ou plusieurs applications.
* **NmsAppSubscriptionRcp** : cette table correspond au schéma **nms:appSubscriptionRcp**. Elle permet de relier les visiteurs et visiteuses abonnés à une application avec la table des personnes destinataires.
...
* **NmsVisitor** : cette table correspond au schéma **nms:visitor**. Elle contient des informations sur les visiteurs et visiteuses.
...
* **NmsFriendShipRel** : cette table correspond au schéma **nms:friendshipRel**. Elle permet de lier des visiteurs et visiteuses à leurs amies et amis dans le cadre du service Facebook.
* **NmsVisitorInterestRel** : cette table correspond au schéma **nms:visitorInterestRel**. Elle permet de lier des visiteurs et visiteuses et leurs centres d’intérêt.
* **NmsInterest** : cette table correspond au schéma **nms:interest**. Elle contient la liste des centres d’intérêt de chaque personne.
