...
>Retrouvez la liste de toutes les API, ainsi que leur description complète, dans [cette documentation dédiée]&#x200B;(https://experienceleague.adobe.com/fr/tools/campaign-api)
