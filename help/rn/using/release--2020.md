...
* La prise en charge de la plage d’identifiants négative a été ajoutée pour la séquence nmsBroadlogId . Ce build ajuste la valeur min_value de la séquence nmsBroadlogId pour inclure la plage négative. Si vous avez un cas d’utilisation strict qui n’autorise pas les identifiants négatifs, veuillez rétablir la valeur min_value de la séquence sur 1.
