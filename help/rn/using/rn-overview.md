...
Les **derniers builds en disponibilité générale** ont les versions suivantes : [[!DNL Gold Standard]  12](../../rn/using/gold-standard.md) et [Campaign 21.1.4](../../rn/using/latest-release.md#release-21-1-4-build-9340).
