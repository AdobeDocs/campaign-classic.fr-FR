...
description: Notes de mise à jour de Campaign Classic 19.2
...
Depuis Campaign Classic 19.2, un état est associé à chaque version. Vous trouverez ci-dessous la liste des états, ce qu’ils signifient et l’image associée :

![](assets/green2.png)**Disponibilité** générale : dernière version stable disponible.

![](assets/blue2.png)**Candidat**&#x200B;à la libération : validé par Adobe, en attente de vérification de la production.

![](assets/orange2.png)**** Plus disponible : nouvelle version disponible, mise à jour requise.

![](assets/green3.png)**Disponibilité** générale : dernière version stable disponible.

![](assets/blue3.png)**Candidat**&#x200B;à la libération : validé par Adobe, en attente de vérification de la production.

![](assets/orange3.png)**** Plus disponible : nouvelle version disponible, mise à jour requise.
...
<table> 
 <tbody> 
  <tr> 
   ...
   <td>Dernière version stable disponible.</td>
  </tr> 
   <tr> 
   <td><img src="assets/blue.png"/></td> 
   <td>Candidat à la libération</td>
   <td>Cette version a été validée par Adobe.  En attente de vérification de la production.</td>
  </tr> 
  <tr> 
   <td><img src="assets/orange.png"/></td> 
   <td>Plus disponible</td>
   <td>Cette version ne pose aucun problème majeur, mais une version plus récente est disponible avec des correctifs supplémentaires. Mise à jour requise.</td>
  </tr> 
 </tbody> 
</table>
...
<tr>
  <td>
    ...
    <div>
    <img src="assets/green3.png"/><strong>Disponibilité générale</strong>
    </div>
    <p>
    <em>Dernière version stable disponible.</em>
    <p>
  </td>
  <td>
    <img src="assets/available.png" />
    <div>
    <img src="assets/blue3.png"/><strong>Candidat à la libération</strong>
    </div>
    <p>
    <em>Cette version a été validée par Adobe. En attente de vérification de la production.</em>
    <p>
  </td>
   <td>
    <img src="assets/update.png" />
    <div>
    <img src="assets/orange3.png"/><strong>Plus disponible</strong>
    </div>
    <p>
    <em>Cette version ne pose aucun problème majeur, mais une version plus récente est disponible avec des correctifs supplémentaires. Mise à jour requise.</em>
    <p>
  </td>
</tr>
</table>
...
|--- |--- |
| [Mise à niveau vers la dernière version](https://helpx.adobe.com/campaign/kb/acc-build-upgrade.html) | [Notes de mise à jour du Panneau de configuration](https://docs.adobe.com/content/help/en/control-panel/using/release-notes.html) |
| [Dernières mises à jour de la documentation](../../rn/using/documentation-updates.md) | [Notes de mises à jour précédentes ](../../rn/using/release--19-1.md) |
| [Fonctionnalités obsolètes et supprimées](https://helpx.adobe.com/campaign/kb/deprecated-and-removed-features.html) |  |

## ![](assets/blue2.png) Version 19.2 - Version 9080 {#release-19-2-build-9080}
...
<table> 
 <thead> 
  <tr> 
   <th> Surveillance en direct du flux de travail<br /> </th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr> 
...
<table> 
 <thead> 
  <tr> 
   <th> Contenu interactif avec AMP<br /> </th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr> 
...
<table> 
 <thead> 
  <tr> 
   <th> Messages SMS sécurisés (TLS)<br /> </th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr> 
