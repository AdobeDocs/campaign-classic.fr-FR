...
<table> 
 <tbody> 
  ...
  <p>Si vous utilisez l’intégration Triggers, vous devez adapter votre mise en oeuvre en conséquence. <a href="../../integrations/using/about-triggers.md">En savoir plus</a></p> 
