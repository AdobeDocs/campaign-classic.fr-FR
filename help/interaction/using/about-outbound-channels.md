...
Les offres peuvent être présentées à divers emplacements en utilisant un canal entrant ou sortant.Ce chapitre traite des canaux sortants.
...
Diverses options sont disponibles pour présenter une offre.Par exemple via une diffusion, une campagne, des compositions de diffusion ou encore via des activités de workflow.
