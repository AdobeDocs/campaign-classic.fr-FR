...
* **[!UICONTROL Offer manager]** : crée et gère des offres
* **[!UICONTROL Delivery manager]** : approuve et utilise les offres
...
1. Accédez à la **[!UICONTROL Groups and named rights]** fenêtre, cliquez sur **[!UICONTROL Add]** et sélectionnez le **[!UICONTROL Offer manager]** groupe.

   ![](assets/offer_operators_create_001.png)

Les droits attribués au chargé d&#39;offres lui permettent d&#39;effectuer les opérations suivantes :

* Modifier **[!UICONTROL Design]** les environnements.
* Afficher les **[!UICONTROL Live]** environnements.
...
1. Créez votre nouvel opérateur.
1. Accédez à la **[!UICONTROL Groups and named rights]** fenêtre, cliquez sur **[!UICONTROL Add]** et sélectionnez le **[!UICONTROL Delivery manager]** groupe.
