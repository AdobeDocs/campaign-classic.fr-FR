...
seo-title: Intégration via SOAP (côté serveur)
...
* **contexte**: vous permet d’ajouter des informations contextuelles dans le schéma d’espace. Si le schéma utilisé est **nms:interaction**, **`<empty>`** doit être ajouté.
...
* **proposition**: chaîne de caractères, elle contient l’identifiant de proposition donné en tant que sortie lors d’une proposition d’offre. Reportez-vous à la proposition [d’](#offer-proposition)offre.
...
* **contexte**: Elément XML, vous permet d’ajouter des informations contextuelles dans le schéma d’espace. Si le schéma utilisé est **nms:interaction**, **`<empty>`** doit être ajouté.
