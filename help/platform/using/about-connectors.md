...
* FDA Connector (**Federated Data Access**) vous permet de connecter Campaign à une ou plusieurs bases de données externes et de traiter les informations stockées dans celles-ci sans affecter vos données Campaign. [En savoir plus](../../platform/using/about-fda.md).
...
>[!NOTE]
>
>La disponibilité de ces modules et leur utilisation peuvent dépendre du type de déploiement de votre installation. Consultez la [matrice des fonctionnalités de Campaign on-premise/hébergé](https://helpx.adobe.com/fr/campaign/kb/acc-on-prem-vs-hosted.html).
