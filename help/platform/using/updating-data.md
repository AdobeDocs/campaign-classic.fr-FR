...
Pour une mise à jour en masse, utilisez l’option **[!UICONTROL Action > Mise à jour en masse des lignes sélectionnées…]**. L’assistant vous assiste dans la configuration et l’exécution de la mise à jour.
