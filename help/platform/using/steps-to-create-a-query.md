...
>[!NOTE]
>
>* Toutes ces étapes sont disponibles dans le requêteur générique.Lorsqu’une requête est créée dans un autre contexte, certaines étapes peuvent être omises.\
