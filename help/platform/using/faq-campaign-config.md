---
title: FAQ sur les paramètres de campagne
...
# FAQ sur les paramètres de campagne {#settings-faq}
...
[Pour en savoir plus, cliquez ici](../../platform/using/accessing-an-external-database.md).
