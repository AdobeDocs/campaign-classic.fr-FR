...
Pour créer un  sur une base de données externe :

1. Cliquez sur le bouton **[!UICONTROL Nouveau]** au-dessus de l’ de l’de l’ de données et choisissez **[!UICONTROL Accès aux données]** externes.
...
1. Cliquez sur **[!UICONTROL Ok]** pour valider. Adobe Campaign détecte automatiquement la structure de la table sélectionnée et génère le schéma logique. Veuillez noter que  Adobe Campaign ne génère pas de liens.
