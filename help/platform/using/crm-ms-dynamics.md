...
1. Cliquez sur le lien **[!UICONTROL Assistant de configuration CRM Microsoft...]** . Adobe Campaign découvre automatiquement les tables du modèle de données Microsoft Dynamics.
