...
>[!NOTE]
>
>Pour en savoir plus sur la confidentialité et la réglementation en matière de sécurité pour Adobe Campaign, consultez la [documentation de Campaign v8](https://experienceleague.adobe.com/fr/docs/campaign/campaign-v8/privacy/security){target=_blank}.
