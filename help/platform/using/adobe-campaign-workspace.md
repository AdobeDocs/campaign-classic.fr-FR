...
1. In the list configuration window, double-click the field to be added in the **[!UICONTROL Available fields]** list in order to add it to the **[!UICONTROL Output columns]**.
   ...
   >
   >Use the **Search** field to run a search in the available fields. Pour plus d’informations, voir [Tri d’une liste](#sorting-a-list).
   >
...
>[!NOTE]
>
>Vous pouvez créer des filtres pour n’afficher que certaines données d’une liste. Voir [Création de filtres](../../platform/using/creating-filters.md).
