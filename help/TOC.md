...
+ Notes de mise à jour {#release-notes}
  ...
  + {hide-from-toc}[Mises à jour de la documentation - MASQUÉ](rn/using/documentation-updates.md)
+ Commencer {#getting-started}
  ...
  + {hide-from-toc}[Utiliser l’explorateur de Campaign - MASQUÉ](platform/using/adobe-campaign-explorer.md)
  + {hide-from-toc}[Parcourir et personnaliser les listes - MASQUÉ](platform/using/adobe-campaign-ui-lists.md)
  + {hide-from-toc}[Énumérations - MASQUÉ](platform/using/managing-enumerations.md)
  ...
  + Gestion des profils {#profile-management}
    ...
    + {hide-from-toc}[Importer et exporter des profils - MASQUÉ](platform/using/exporting-and-importing-profiles.md)
  ...
  + {hide-from-toc}[Procédure à suivre pour créer une requête - MASQUÉ](platform/using/steps-to-create-a-query.md)
  ...
  + Connecteurs CRM {#connectors}
    ...
    + {hide-from-toc}[Connexion à Salesforce.com](platform/using/crm-sfdc.md)
    + {hide-from-toc}[Synchroniser des données avec le CRM](platform/using/crm-data-sync.md)
  + {hide-from-toc}[Aide et options d’assistance - MASQUÉ](support.md)
+ Créer et envoyer des messages {#sending-messages}
  ...
  + Démarrage rapide {#key-steps-when-creating-a-delivery}
    + {hide-from-toc}[Commencer avec les diffusions - MASQUÉ](delivery/using/steps-about-delivery-creation-steps.md)
  ...
  + Bonnes pratiques de diffusion {#delivery-bestpractices}
    ...
    + {hide-from-toc}[Définir l’audience appropriée - MASQUÉ](delivery/using/define-the-right-audience.md)
    + {hide-from-toc}[Vérifier avant envoi - MASQUÉ](delivery/using/check-before-sending.md)
  + [Envoyer des e-mails](delivery/using/about-email-channel.md)
  + Envoyer des e-mails {#sending-emails}
    + {hide-from-toc}[Créer une diffusion par e-mail - MASQUÉ](delivery/using/creating-an-email-delivery.md)
    + {hide-from-toc}[Définir le contenu de l’e-mail - MASQUÉ](delivery/using/defining-the-email-content.md)
    + {hide-from-toc}[Définir le contenu interactif - MASQUÉ](delivery/using/defining-interactive-content.md)
    + Envoyer la diffusion par e-mail {#sending-an-email}
      ...
      + {hide-from-toc}[Envoyer sur des mobiles japonais - MASQUÉ](delivery/using/sending-emails-on-japanese-mobiles.md)
  ...
  + Envoyer un SMS {#sending-messages-on-mobiles}
    ...
    + {hide-from-toc}[Migrer vers le connecteur SMPP générique étendu](delivery/using/unsupported-connector-migration.md)
  ...
  + Envoyer des notifications push {#sending-push-notifications}
    + {hide-from-toc}[Intégrer le SDK Campaign dans l’application mobile](delivery/using/integrating-campaign-sdk-into-the-mobile-application.md)
    + Configurer l’application mobile{#configure-the-mobile-app}
      + {hide-from-toc}[Commencer avec la configuration de l’application - MASQUÉ](delivery/using/get-started-app-config.md)
    ...
    + Créer une notification push{#create-a-push-msg}
      + {hide-from-toc}[Créer un message push pour iOS - MASQUÉ](delivery/using/create-notifications-ios.md)
      + {hide-from-toc}[Créer un message push pour Android - MASQUÉ](delivery/using/create-notifications-android.md)
    + {hide-from-toc}[Résolution des problèmes - MASQUÉ](delivery/using/troubleshooting.md)
  + [Envoyer des courriers](delivery/using/about-direct-mail-channel.md)
  + Envoyer un courrier {#sending-direct-mail}
    + {hide-from-toc}[Créer une diffusion par courrier - MASQUÉ](delivery/using/creating-a-direct-mail-delivery.md)
    + {hide-from-toc}[Définir le contenu du courrier - MASQUÉ](delivery/using/defining-the-direct-mail-content.md)
    + {hide-from-toc}[Valider - MASQUÉ](delivery/using/validating.md)
  + Utiliser des modèles de diffusion {#using-delivery-templates}
    + {hide-from-toc}[Utiliser des modèles de diffusion - MASQUÉ](delivery/using/about-templates.md)
    ...
    + {hide-from-toc}[Créer une diffusion à partir d’un modèle - MASQUÉ](delivery/using/creating-a-delivery-from-a-template.md)
  + Personnaliser les diffusions {#personalizing-deliveries}
    ...
    + {hide-from-toc}[Champs de personnalisation - MASQUÉ](delivery/using/personalization-fields.md)
    + {hide-from-toc}[Blocs de personnalisation - MASQUÉ](delivery/using/personalization-blocks.md)
    + {hide-from-toc}[Contenu conditionnel - MASQUÉ](delivery/using/conditional-content.md)
    + {hide-from-toc}[Coupons personnalisés - MASQUÉ](delivery/using/personalized-coupons.md)
...
+ Orchestrer des campagnes marketing {#orchestrating-campaigns}
  + {hide-from-toc}[À propos de l’optimisation de campagne - MASQUÉ](campaign-opt/using/about-campaign-optimization.md)
  ...
  + Orchestrer des campagnes {#orchestrate-campaigns}
    + {hide-from-toc}[Commencer avec les campagnes marketing - MASQUÉ](campaign/using/setting-up-marketing-campaigns.md)
    ...
    + {hide-from-toc}[Gérer les documents et les ressources - MASQUÉ](campaign/using/marketing-campaign-assets.md)
    + {hide-from-toc}[Configurer et gérer les validations - MASQUÉ](campaign/using/marketing-campaign-approval.md)
    + {hide-from-toc}[Surveiller vos campagnes - MASQUÉ](campaign/using/marketing-campaign-monitoring.md)
    + {hide-from-toc}[Prestataires, stocks et budgets - MASQUÉ](campaign/using/providers-stocks-and-budgets.md)
  + Optimisation de campagne {#campaign-optimization}
    ...
    + {hide-from-toc}[Règles de pression - MASQUÉ](campaign-opt/using/pressure-rules.md)
    + {hide-from-toc}[Règles de cohérence - MASQUÉ](campaign-opt/using/consistency-rules.md)
    + {hide-from-toc}[Règles de contrôle - MASQUÉ](campaign-opt/using/control-rules.md)
    + {hide-from-toc}[Règles de filtrage - MASQUÉ](campaign-opt/using/filtering-rules.md)
    + {hide-from-toc}[Appliquer des règles - MASQUÉ](campaign-opt/using/applying-rules.md)
    + {hide-from-toc}[Simulations de campagnes - MASQUÉ](campaign-opt/using/campaign-simulations.md)
+ Gestion des ressources marketing {#mrm}
  ...
  + {hide-from-toc}[Maîtriser les coûts - MASQUÉ](mrm/using/controlling-costs.md)
  + {hide-from-toc}[Gérer des ressources marketing - MASQUÉ](mrm/using/managing-marketing-resources.md)
  + {hide-from-toc}[Forums de discussion - MASQUÉ](mrm/using/discussion-forums.md)
+ Marketing distribué {#distributed-marketing}
  ...
  + {hide-from-toc}[Publier le kit de campagne - MASQUÉ](distributed/using/publishing-the-campaign-package.md)
  + {hide-from-toc}[Accéder aux campagnes - MASQUÉ](distributed/using/accessing-campaigns.md)
  + {hide-from-toc}[Suivre une campagne - MASQUÉ](distributed/using/tracking-a-campaign.md)
...
+ Intégrer à Adobe Experience Cloud {#integrating-with-adobe-experience-cloud}
  ...
  + Connecteur ACS {#acs-connector}
    + {hide-from-toc}[Commencer avec  [!DNL ACS Connector]  - MASQUÉ](integrations/using/acs-connector-principles-and-data-cycle.md)
    + {hide-from-toc}[Synchroniser des profils - MASQUÉ](integrations/using/synchronizing-profiles.md)
    + {hide-from-toc}[Synchroniser des audiences - MASQUÉ](integrations/using/synchronizing-audiences.md)
    + {hide-from-toc}[Synchroniser des applications web - MASQUÉ](integrations/using/synchronizing-web-applications.md)
    + {hide-from-toc}[Résoudre des problèmes liés au  [!DNL ACS Connector]  - MASQUÉ](integrations/using/troubleshooting-the-acs-connector.md)
...
+ Automatiser avec des workflows {#automating-with-workflows}
  + Commencer avec les workflows {#introduction}
    ...
    + {hide-from-toc}[Données cibles - MASQUÉ](workflow/using/targeting-data.md)
    + {hide-from-toc}[Utiliser des données de workflow - MASQUÉ](workflow/using/how-to-use-workflow-data.md)
    + {hide-from-toc}[Bonnes pratiques en matière de workflow - MASQUÉ](workflow/using/workflow-best-practices.md)
  + Exécuter un workflow {#executing-a-workflow}
    ...
    + {hide-from-toc}[Définir des validations - MASQUÉ](workflow/using/defining-approvals.md)
    + {hide-from-toc}[Architecture - MASQUÉ](workflow/using/architecture.md)
  + Activités de ciblage {#targeting-activities}
    ...
    + {hide-from-toc}[Requête - MASQUÉ](workflow/using/query.md)
    + {hide-from-toc}[Requête incrémentale - MASQUÉ](workflow/using/incremental-query.md)
    + {hide-from-toc}[Lecture de liste - MASQUÉ](workflow/using/read-list.md)
    + {hide-from-toc}[Union - MASQUÉ](workflow/using/union.md)
    + {hide-from-toc}[Intersection - MASQUÉ](workflow/using/intersection.md)
    + {hide-from-toc}[Exclusion - MASQUÉ](workflow/using/exclusion.md)
    + {hide-from-toc}[Partage - MASQUÉ](workflow/using/split.md)
    + {hide-from-toc}[Cellules - MASQUÉ](workflow/using/cells.md)
    + {hide-from-toc}[Offres par cellule - MASQUÉ](workflow/using/offers-by-cell.md)
    + {hide-from-toc}[Composition de diffusion - MASQUÉ](workflow/using/delivery-outline.md)
    ...
    + {hide-from-toc}[Déduplication - MASQUÉ](workflow/using/deduplication.md)
    ...
    + {hide-from-toc}[Mettre à jour les données - MASQUÉ](workflow/using/update-data.md)
  ...
  + Activités de contrôle de flux {#flow-control-activities}
    + {hide-from-toc}[À propos des activités de contrôle de flux - MASQUÉ](workflow/using/about-flow-control-activities.md)
    ...
    + {hide-from-toc}[Attente - MASQUÉ](workflow/using/wait.md)
    ...
    + {hide-from-toc}[Saut (départ et arrivée - MASQUÉ)](workflow/using/jump-start-point-and-end-point.md)
    + {hide-from-toc}[Signal externe - MASQUÉ](workflow/using/external-signal.md)
    + {hide-from-toc}[Validation - MASQUÉ](workflow/using/approval.md)
    + {hide-from-toc}[Alerte - MASQUÉ](workflow/using/alert.md)
    + {hide-from-toc}[Tâche - MASQUÉ](workflow/using/task.md)
  + Activités d’action {#action-activities}
    ...
    + {hide-from-toc}[Diffusion - MASQUÉ](workflow/using/delivery.md)
    + {hide-from-toc}[Agir sur une diffusion - MASQUÉ](workflow/using/delivery-control.md)
    + {hide-from-toc}[Diffusion continue - MASQUÉ](workflow/using/continuous-delivery.md)
    + {hide-from-toc}[Diffusion récurrente - MASQUÉ](workflow/using/recurring-delivery.md)
    + {hide-from-toc}[Diffusions cross-canal - MASQUÉ](workflow/using/cross-channel-deliveries.md)
    + {hide-from-toc}[Validation en local - MASQUÉ](workflow/using/local-approval.md)
    + {hide-from-toc}[Chargement des données (RDBMS) - MASQUÉ](workflow/using/data-loading-rdbms.md)
    + {hide-from-toc}[Chargement (SOAP) - MASQUÉ](workflow/using/loading-soap.md)
    + {hide-from-toc}[Chargement des données (fichier) - MASQUÉ](workflow/using/data-loading-file.md)
    + {hide-from-toc}[Gestion de contenu - MASQUÉ](workflow/using/content-management.md)
    + {hide-from-toc}[Extraction des données (fichier) - MASQUÉ](workflow/using/extraction-file.md)
    + {hide-from-toc}[Code SQL et code JavaScript - MASQUÉ](workflow/using/sql-code-and-javascript-code.md)
    + {hide-from-toc}[Gestion des données SQL - MASQUÉ](workflow/using/sql-data-management.md)
    + {hide-from-toc}[Module Nlserver - MASQUÉ](workflow/using/nlserver-module.md)
    + {hide-from-toc}[Mettre à jour l’agrégat - MASQUÉ](workflow/using/update-aggregate.md)
  + Activités d’événement {#event-activities}
    ...
    + {hide-from-toc}[Transfert de fichiers - MASQUÉ](workflow/using/file-transfer.md)
    + {hide-from-toc}[Téléchargement web - MASQUÉ](workflow/using/web-download.md)
    + {hide-from-toc}[E-mails entrants - MASQUÉ](workflow/using/inbound-emails.md)
    + {hide-from-toc}[SMS entrants - MASQUÉ](workflow/using/inbound-sms.md)
  + Cas d’utilisation {#use-cases}
    + {hide-from-toc}[À propos des cas d’utilisation de workflow - MASQUÉ](workflow/using/about-workflow-use-cases.md)
    + Diffusions {#deliveries}
      + {hide-from-toc}[Utiliser l’activité de validation en local - MASQUÉ](workflow/using/using-the-local-approval-activity.md)
      ...
      + {hide-from-toc}[Enrichissement des e-mails avec des champs de date personnalisés - MASQUÉ](workflow/using/email-enrichment-with-custom-date-fields.md)
  + Surveillance {#monitoring}
    + {hide-from-toc}[Envoyer un rapport à une liste - MASQUÉ](workflow/using/sending-a-report-to-a-list.md)
    + {hide-from-toc}[Superviser vos workflows - MASQUÉ](workflow/using/supervising-workflows.md)
    + {hide-from-toc}[Envoyer des alertes personnalisées aux opérateurs et opératrices - MASQUÉ](workflow/using/sending-personalized-alerts-to-operators.md)
  + Gestion des données {#data-management}
    + {hide-from-toc}[Coordonner les mises à jour des données - MASQUÉ](workflow/using/coordinating-data-updates.md)
    ...
    + {hide-from-toc}[Utiliser la fonctionnalité de fusion de l’activité de déduplication - MASQUÉ](workflow/using/deduplication-merge.md)
    + {hide-from-toc}[Configurer un workflow d’import récurrent - MASQUÉ](workflow/using/recurring-import-workflow.md)
  + Requêtes de conception {#designing-queries}
    + {hide-from-toc}[Mise à jour de la liste trimestrielle à l’aide d’une requête incrémentale - MASQUÉ](workflow/using/quarterly-list-update.md)
  + Requête et filtre {#query-and-filter-hidden}
    + {hide-from-toc}[Effectuer une requête sur la table des personnes destinataires - MASQUÉ](workflow/using/querying-recipient-table.md)
    + {hide-from-toc}[Effectuer une requête sur les informations sur la diffusion - MASQUÉ](workflow/using/querying-delivery-information.md)
    + {hide-from-toc}[Exécuter un calcul d’agrégats - MASQUÉ](workflow/using/performing-aggregate-computing.md)
    + {hide-from-toc}[Effectuer une requête avec gestion des regroupements - MASQUÉ](workflow/using/querying-using-grouping-management.md)
    + {hide-from-toc}[Effectuer une requête avec une relation multiple-à-multiple - MASQUÉ](workflow/using/querying-using-many-to-many-relationship.md)
    ...
    + {hide-from-toc}[Filtrer les personnes destinataires en double - MASQUÉ](workflow/using/filtering-duplicated-recipients.md)
  + Surveiller les workflows {#monitoring-workflows}
    + {hide-from-toc}[Surveiller l’exécution des workflows - MASQUÉ](workflow/using/monitoring-workflow-execution.md)
    + {hide-from-toc}[Surveiller les workflows techniques - MASQUÉ](workflow/using/monitoring-technical-workflows.md)
  ...
  + Gestion avancée {#advanced-management}
    ...
    + {hide-from-toc}[Scripts et modèles JavaScript - MASQUÉ](workflow/using/javascript-scripts-and-templates.md)
    ...
    + {hide-from-toc}[Gérer les autorisations - MASQUÉ](workflow/using/managing-rights.md)
    + {hide-from-toc}[Modifier les images d’activité - MASQUÉ](workflow/using/managing-activity-images.md)
    + {hide-from-toc}[Gérer les fuseaux horaires - MASQUÉ](workflow/using/managing-time-zones.md)
    + {hide-from-toc}[Workflows techniques - MASQUÉ](workflow/using/about-technical-workflows.md)
...
+ Guide de migration {#migrating-to-a-new-version}
  + {hide-from-toc}[Migrer vers Adobe Campaign v7](migration/using/about-migration.md)
  ...
  + Démarrer la migration {#migrating-to-adobe-campaign-7}
    + {hide-from-toc}[Migrer une plateforme Microsoft Windows](migration/using/migrating-in-windows-for-adobe-campaign-7.md)
    + {hide-from-toc}[Migrer une plateforme Linux](migration/using/migrating-in-linux-for-adobe-campaign-v7.md)
...
+ Notes techniques {#technotes}
  ...
  + Mises à niveau et compatibilité{#technote-migration}
    ...
    + {hide-from-toc}[Mise à niveau de la sécurité d’Apache](technotes/using/acc-apache-upgrade.md)
  ...
  + Emails et notifications push{#technotes-email}
    ...
    + {hide-from-toc}[Mettre à jour les rebonds définitifs incorrects après une panne d’un FAI](delivery/using/update-bounces.md)
