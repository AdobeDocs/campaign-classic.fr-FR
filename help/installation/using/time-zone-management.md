...
* America/New_York, etc.
   ...
   Ces valeurs sont issues de la base tz (Olson). Pour plus d&#39;informations, consultez la page suivante : [http://en.wikipedia.org/wiki/List_of_tz_database_time_zones](http://en.wikipedia.org/wiki/List_of_tz_database_time_zones).
