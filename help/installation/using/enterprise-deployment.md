...
1. Copie du programme d’installation de la console cliente **setup-client-7.XX**, **YYYY.exe** au **/datakit/nl/eng/jsp** dossier. [En savoir plus](../../installation/using/client-console-availability-for-windows.md).
