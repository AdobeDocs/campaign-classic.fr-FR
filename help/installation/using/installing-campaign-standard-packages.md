...
1. Installez le nouveau canal, par exemple le **Canal mobile**, à l’aide de l’assistant d’importation de package ( **[!UICONTROL Outils > Avancé > Import de package > Package Adobe Campaign]**).
