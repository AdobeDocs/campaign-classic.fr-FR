...
1. Règles de contrôle, si elles s’appliquent au début de la personnalisation. Si les règles des utilisateurs et utilisatrices (filtrage/pression/capacitif) sont à recalculer du fait de leur expiration, elles sont appliquées à cette étape.
