...
---
# INVITE 2 : Analyse de la Détaillée d&#39;un dossier
...
1. **Copiez l’invite entière ci-dessus**
2. **Remplacer le chemin du dossier** :
...
Essayez avec :
- `/help/delivery/using/` (111 fichiers)
- `/help/workflow/using/` (121 fichiers)
...
Le rapport comprendra entre 30 et 40 pages de Markdown détaillé avec :
- Synthèse des statistiques
- Compléter le tableau avec tous les fichiers
- Jusqu’à 3 correspondances v8 par fichier
- Pourcentages de correspondance
- Récapitulatifs détaillés des fichiers
- Plan de réorganisation
- Éléments action

Parfait pour l&#39;exécution ! ✅
